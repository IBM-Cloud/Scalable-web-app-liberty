...
Follow these two easy steps to create an IBM Cloud Schematics workspace and apply a Terraform execution plan. When you apply the plan, a Kubernetes cluster is created, and a Java Liberty application is deployed to it by using an IBM Cloud DevOps toolchain.
